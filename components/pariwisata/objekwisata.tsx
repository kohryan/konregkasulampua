...
export function Objekwisata() {
    ...
    <div className="max-w-2xl mx-auto py-2 px-2 sm:py-2 sm:px-2 lg:max-w-7xl lg:px-2">
        <div className="mt-2 grid grid-cols-2 gap-y-10 sm:grid-cols-2 gap-x-2 lg:grid-cols-4 xl:grid-cols-3 xl:gap-x-2">
                ...
                <div key={item.id} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-5">
                        ...
                        <div className="mb-1 flex items-center justify-between align-middle"> 
                            ...
                            <MapPinIcon className="flex-shrink-0 h-6 w-6 text-red-500 inline-flex" aria-hidden="true"/> {item.jarak} km</p>
                        </div>
                        <div className="mb-1 flex items-center justify-between align-middle"> 
                            <p className="font-normal text-gray-700 dark:text-white"> 
                        ...
                        <div className="mb-1 flex items-center justify-between">
                            <span className="text-md font-normal text-gray-900 dark:text-white"> 
                            <TicketIcon className="flex-shrink-0 h-6 w-6 text-green-500 inline-flex" aria-hidden="true"/> <b>Tiket:</b> IDR ≥ {item.tiket}k</span>
                        </div>
