...
export function Card() {
    return (
        <div className="max-w-2xl mx-auto py-12 px-4 sm:py-12 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="grid grid-cols-1 gap-y-10 mt-4 sm:grid-cols-2 gap-x-6 lg:grid-cols-4 xl:grid-cols-4 xl:gap-x-8 mx-auto mb-0">
            ...
            <FadeIn className="z-10" delay={0.1}>
                <div className="max-w-sm backdrop-blur-sm bg-white/30 border border-gray-200 rounded-lg shadow dark:bg-gray-800/30 dark:border-gray-700">
                    ...
                    <div className="p-5 text-center justify-center">
                        ...
                        <Link href="/kasulampua/informasi" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Selengkapnya
            ...
            <FadeIn className="z-10" delay={0.2}>
                <div className="max-w-sm backdrop-blur-sm bg-white/30 border border-gray-200 rounded-lg shadow dark:bg-gray-800/30 dark:border-gray-700">
                    ...
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Info Akomodasi</h5>
                        ...
                        <Link href="/akomodasi" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Selengkapnya
                            <svg aria-hidden="true" className="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        </Link>
                    </div>
            ...
            <FadeIn className="z-10" delay={0.3}>
                <div className="max-w-sm backdrop-blur-sm bg-white/30 border border-gray-200 rounded-lg shadow dark:bg-gray-800/30 dark:border-gray-700">
                    ...
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Info Wisata</h5>
                        ...
                        <Link href="/wisata" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Selengkapnya
                            <svg aria-hidden="true" className="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        </Link>
                    </div>
            ...
            <FadeIn className="z-10" delay={0.4}>
                <div className="max-w-sm backdrop-blur-sm bg-white/30 border border-gray-200 rounded-lg shadow dark:bg-gray-800/30 dark:border-gray-700">
                    ...
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Hubungi Kami</h5>
                        ...
                        <Link href="/kontak"className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Selengkapnya
                            <svg aria-hidden="true" className="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        </Link>
                    </div>
